        ...
        <nav className="flex-1 px-3 py-4 flex flex-col gap-1">
          ...
          <button
            ...
            className={`flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-colors ${
              activeView === 'canvas' ? 'bg-slate-800 text-white' : 'hover:bg-slate-800/50 hover:text-white'
            }`}
          >
            <LayoutGrid size={16} />
            Árbol Canvas
          ...
          <button
            ...
            className={`flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-colors ${
              activeView === 'feed' ? 'bg-slate-800 text-white' : 'hover:bg-slate-800/50 hover:text-white'
            }`}
          >
            <MessageSquareText size={16} />
            Feed de Recuerdos
            {memoriesCount > 0 && (
              <span className="ml-auto bg-orange-600 text-white text-[10px] py-0.5 px-2 rounded-full font-bold">
                {memoriesCount}
              </span>
            )}
          </button>
